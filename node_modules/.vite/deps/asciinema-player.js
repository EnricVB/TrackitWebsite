...
var require_regeneratorRuntime = __commonJS({
  "node_modules/@babel/runtime/helpers/regeneratorRuntime.js"(exports2, module) {
...
var require_regenerator = __commonJS({
  "node_modules/@babel/runtime/regenerator/index.js"(exports2, module) {
...
function render(code, element, init2) {
  ...
  createRoot((dispose2) => {
    disposer = dispose2;
    insert(element, code(), element.firstChild ? null : void 0, init2);
  });
  return () => {
    disposer();
    element.textContent = "";
...
var VtWrapper = function() {
  function VtWrapper2() {
    _classCallCheck(this, VtWrapper2);
  }
  _createClass(VtWrapper2, [{
    ...
    */
    ...
    value: function __wrap(ptr) {
      var obj = Object.create(VtWrapper2.prototype);
      obj.ptr = ptr;
      return obj;
    }
  }]);
...
function _load() {
  _load = _asyncToGenerator(import_regenerator.default.mark(function _callee(module, imports) {
    var bytes, instance;
...
function _init() {
  _init = _asyncToGenerator(import_regenerator.default.mark(function _callee2(input) {
...
var Core = function() {
  function Core2(driverFn, opts) {
    ...
    this.rows = opts.rows;
    this.startTime = null;
    this.speed = (_opts$speed = opts.speed) !== null && _opts$speed !== void 0 ? _opts$speed : 1;
    this.loop = opts.loop;
  ...
  _createClass(Core2, [{
    key: "init",
    value: function() {
      var _init2 = _asyncToGenerator(import_regenerator.default.mark(function _callee() {
        var _this = this, _this$cols, _this$rows;
        var playCount, feed, now2, setTimeout2, setInterval2, reset, onFinish;
        return import_regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                now2 = this.now.bind(this);
                setTimeout2 = function setTimeout3(f, t) {
                  return window.setTimeout(f, t / _this.speed);
                };
                setInterval2 = function setInterval3(f, t) {
                  return window.setInterval(f, t / _this.speed);
                };
                reset = function reset2(cols, rows) {
    ...
    key: "play",
    value: function() {
      var _play = _asyncToGenerator(import_regenerator.default.mark(function _callee2() {
        return import_regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
    ...
    key: "pauseOrResume",
    value: function() {
      var _pauseOrResume = _asyncToGenerator(import_regenerator.default.mark(function _callee3() {
    ...
    key: "seek",
    value: function() {
      var _seek = _asyncToGenerator(import_regenerator.default.mark(function _callee4(where) {
    ...
    value: function getChangedLines() {
      if (this.changedLines.size > 0) {
        ...
        var _iterator = _createForOfIteratorHelper(this.changedLines), _step;
        try {
    ...
    key: "start",
    value: function() {
      var _start = _asyncToGenerator(import_regenerator.default.mark(function _callee5() {
        var stop;
    ...
    key: "restart",
    value: function() {
      var _restart = _asyncToGenerator(import_regenerator.default.mark(function _callee6() {
    ...
    value: function initializeDriver() {
      if (this.initializeDriverPromise === void 0) {
    ...
    value: function() {
      var _doInitializeDriver = _asyncToGenerator(import_regenerator.default.mark(function _callee7() {
    ...
    value: function ensureVt() {
      ...
      if (this.vt !== void 0 && this.vt.cols === cols && this.vt.rows === rows) {
        return;
      }
    ...
    key: "renderPoster",
    value: function() {
      var _renderPoster = _asyncToGenerator(import_regenerator.default.mark(function _callee8() {
        var _this3 = this;
...
var _tmpl$$6 = template(`<span></span>`);
var Segment = function(props) {
  return function() {
    ...
    createRenderEffect(function(_p$) {
      var _v$ = className(props.attrs, props.extraClass), _v$2 = classList(props.attrs), _v$3 = style(props.attrs);
...
var _tmpl$$5 = template(`<span class="line"></span>`);
var Line = function(props) {
  var segments = function segments2() {
...
var _tmpl$$4 = template(`<pre class="asciinema-terminal"></pre>`);
var Terminal = function(props) {
  var terminalStyle = function terminalStyle2() {
    return {
      width: "".concat(props.cols, "ch"),
      height: "".concat(1.3333333333 * props.rows, "em"),
      "font-size": "".concat((props.scale || 1) * 100, "%")
    };
  };
  var cursorCol = function cursorCol2() {
    var _props$cursor;
    return (_props$cursor = props.cursor) === null || _props$cursor === void 0 ? void 0 : _props$cursor[0];
  };
  var cursorRow = function cursorRow2() {
    var _props$cursor2;
  ...
  return function() {
    ...
    insert(_el$, createComponent(For, {
      ...
      children: function children2(line, i) {
        return function() {
    ...
    createRenderEffect(function(_p$) {
      var _v$ = props.blink || props.cursorHold, _v$2 = props.blink, _v$3 = terminalStyle();
...
var ControlBar = function(props) {
  ...
  var onSeek = function onSeek2(e2) {
    if (e2.altKey || e2.shiftKey || e2.metaKey || e2.ctrlKey) {
      return;
    }
    var barWidth = e2.currentTarget.offsetWidth;
    var rect = e2.currentTarget.getBoundingClientRect();
    var mouseX = e2.clientX - rect.left;
    var pos = mouseX / barWidth;
    return props.onSeekClick("".concat(pos * 100, "%"));
  };
  return function() {
    var _el$ = _tmpl$5.cloneNode(true), _el$5 = _el$.firstChild, _el$6 = _el$5.firstChild, _el$7 = _el$6.nextSibling, _el$8 = _el$5.nextSibling;
    ...
    insert(_el$, createComponent(Show, {
      ...
      get children() {
        var _el$9 = _tmpl$4.cloneNode(true), _el$10 = _el$9.firstChild, _el$11 = _el$10.firstChild, _el$12 = _el$11.firstChild;
...
var _tmpl$$2 = template(`<div class="loading"><div class="loader"></div></div>`);
...
var _tmpl$ = template(`<div class="asciinema-player-wrapper" tabindex="-1"><div></div></div>`);
var Player = function(props) {
  ...
  var _createStore = createStore({
    ...
    blink: true,
    cursorHold: false
  }), _createStore2 = _slicedToArray(_createStore, 2), state = _createStore2[0], setState = _createStore2[1];
  ...
  var terminalRef;
  var resizeObserver;
  var terminalCols = function terminalCols2() {
    return state.cols || 80;
  };
  var terminalRows = function terminalRows2() {
  ...
  var measureDomElements = function measureDomElements2() {
    setState({
  ...
  var setupResizeObserver = function setupResizeObserver2() {
  ...
  onMount(_asyncToGenerator(import_regenerator.default.mark(function _callee() {
  ...
  var play = function() {
    var _ref2 = _asyncToGenerator(import_regenerator.default.mark(function _callee2() {
      var timeoutId;
      return import_regenerator.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
  ...
  var pauseOrResume = function() {
    var _ref3 = _asyncToGenerator(import_regenerator.default.mark(function _callee3() {
      var isPlaying;
      return import_regenerator.default.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
    ...
    return function pauseOrResume2() {
      return _ref3.apply(this, arguments);
    };
  }();
  var seek = function() {
    var _ref4 = _asyncToGenerator(import_regenerator.default.mark(function _callee4(pos) {
      return import_regenerator.default.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
    ...
    return function seek2(_x) {
      return _ref4.apply(this, arguments);
    };
  }();
  var updateTerminal = function updateTerminal2() {
  ...
  var toggleFullscreen = function toggleFullscreen2() {
    ...
    if ((_document$fullscreenE = document.fullscreenElement) !== null && _document$fullscreenE !== void 0 ? _document$fullscreenE : document.webkitFullscreenElement) {
      ...
      ((_ref5 = (_document$exitFullscr = document.exitFullscreen) !== null && _document$exitFullscr !== void 0 ? _document$exitFullscr : document.webkitExitFullscreen) !== null && _ref5 !== void 0 ? _ref5 : function() {
      }).apply(document);
    } else {
      var _ref6, _wrapperRef$requestFu;
      ((_ref6 = (_wrapperRef$requestFu = wrapperRef.requestFullscreen) !== null && _wrapperRef$requestFu !== void 0 ? _wrapperRef$requestFu : wrapperRef.webkitRequestFullscreen) !== null && _ref6 !== void 0 ? _ref6 : function() {
      }).apply(wrapperRef);
    }
  };
  ...
  var startTimeUpdates = function startTimeUpdates2() {
    timeUpdateIntervalId = setInterval(updateTime, 100);
  };
  var stopTimeUpdates = function stopTimeUpdates2() {
    clearInterval(timeUpdateIntervalId);
  };
  var updateTime = function updateTime2() {
  ...
  var startBlinking = function startBlinking2() {
  ...
  var stopBlinking = function stopBlinking2() {
    clearInterval(blinkIntervalId);
    setState("blink", true);
  };
  var showControls = function showControls2(show) {
    clearTimeout(userActivityTimeoutId);
    if (show) {
      userActivityTimeoutId = setTimeout(function() {
        return showControls2(false);
      }, 2e3);
    }
    setState("showControls", show);
  };
  var playerStyle = function playerStyle2() {
    var style2 = {};
    if ((props.fit === false || props.fit === "none") && props.fontSize !== void 0) {
      if (props.fontSize === "small") {
        ...
        style2["font-size"] = props.fontSize;
      }
    }
  ...
  return function() {
    ...
    createRenderEffect(function(_p$) {
      var _v$ = state.showControls, _v$2 = playerClass(), _v$3 = playerStyle();
...
var Stream = function(_Symbol$iterator) {
  function Stream2(input, xfs) {
  ...
  _createClass(Stream2, [{
    ...
    value: function transform(f) {
      return new Stream2(this.input, this.xfs.concat([f]));
    }
  }, {
    key: "toArray",
...
function asciicast(_ref, _ref2, _ref3) {
  var url = _ref.url;
  var feed = _ref2.feed, now2 = _ref2.now, setTimeout2 = _ref2.setTimeout, onFinish = _ref2.onFinish;
  ...
  function _load2() {
    _load2 = _asyncToGenerator(import_regenerator.default.mark(function _callee3() {
      var res, _asciicast;
      return import_regenerator.default.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
  ...
  function scheduleNextFrame() {
    ...
    if (nextFrame) {
      var t = nextFrame[0] * 1e3;
      var elapsedWallTime = now2() - startTime;
      var timeout = t - elapsedWallTime;
      if (timeout < 0) {
        timeout = 0;
      }
      timeoutId = setTimeout2(runFrame, timeout);
    } else {
      timeoutId = null;
  ...
  function runFrame() {
    ...
    do {
      feed(frame[1]);
      elapsedVirtualTime = frame[0] * 1e3;
      frame = frames[++nextFrameIndex];
      elapsedWallTime = now2() - startTime;
    } while (frame && elapsedWallTime > frame[0] * 1e3);
    scheduleNextFrame();
  }
  function pause() {
    clearTimeout(timeoutId);
  ...
  function _seek(where) {
    ...
    if (typeof where === "number") {
      ...
      where = Math.max(0, ((_pauseElapsedTime = pauseElapsedTime) !== null && _pauseElapsedTime !== void 0 ? _pauseElapsedTime : 0) / (duration * 1e3) - 0.1);
    } else if (where === ">>") {
      var _pauseElapsedTime2;
      where = Math.min(1, ((_pauseElapsedTime2 = pauseElapsedTime) !== null && _pauseElapsedTime2 !== void 0 ? _pauseElapsedTime2 : 0) / (duration * 1e3) + 0.1);
    ...
    var targetTime = duration * where * 1e3;
    ...
    var frame = frames[nextFrameIndex];
    while (frame && frame[0] * 1e3 < targetTime) {
      feed(frame[1]);
      elapsedVirtualTime = frame[0] * 1e3;
      frame = frames[++nextFrameIndex];
    }
  ...
  function _getPoster(time) {
    var posterTime = time * 1e3;
    var poster = [];
    var nextFrameIndex2 = 0;
    var frame = frames[0];
    while (frame && frame[0] * 1e3 < posterTime) {
      poster.push(frame[1]);
      frame = frames[++nextFrameIndex2];
    }
    return poster;
  }
  return {
    ...
    start: function() {
      var _start = _asyncToGenerator(import_regenerator.default.mark(function _callee2(startAt) {
        return import_regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
    ...
    getCurrentTime: function getCurrentTime() {
      if (timeoutId) {
        ...
        return ((_pauseElapsedTime3 = pauseElapsedTime) !== null && _pauseElapsedTime3 !== void 0 ? _pauseElapsedTime3 : 0) / 1e3;
      }
    }
  };
}
...
function parseAsciicastV1(json) {
  var asciicast2 = JSON.parse(json);
  var time = 0;
  var frames = new Stream(asciicast2.stdout).map(function(e) {
    time += e[0];
    return [time, e[1]];
  });
  return {
    cols: asciicast2.width,
    rows: asciicast2.height,
    frames
  };
}
...
function limitFrames(frames) {
  var idleTimeLimit = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Infinity;
  var prevT = 0;
  var shift = 0;
...
function clock(_ref3, _ref4) {
  var feed = _ref3.feed;
  var _ref4$cols = _ref4.cols, cols = _ref4$cols === void 0 ? 5 : _ref4$cols, _ref4$rows = _ref4.rows, rows = _ref4$rows === void 0 ? 1 : _ref4$rows;
...
function buffer(feed, bufferTime) {
  ...
  var startTime;
  var stopFeeding = events.forEach(function() {
    var _ref = _asyncToGenerator(import_regenerator.default.mark(function _callee(event) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              elapsedStreamTime = (event[0] + bufferTime) * 1e3;
...
function websocket(_ref, _ref2) {
  var url = _ref.url, _ref$bufferTime = _ref.bufferTime, bufferTime = _ref$bufferTime === void 0 ? 0 : _ref$bufferTime;
  var feed = _ref2.feed, reset = _ref2.reset;
  ...
  function connect() {
    ...
    socket.onmessage = function(event) {
      if (typeof event.data === "string") {
        ...
        if (e.cols !== void 0 || e.width !== void 0) {
          var _e$cols, _e$rows;
          initBuffer();
...
function getDriver(src) {
  ...
  var drivers = /* @__PURE__ */ new Map([["asciicast", asciicast], ["websocket", websocket], ["eventsource", eventsource], ["test", test]]);
